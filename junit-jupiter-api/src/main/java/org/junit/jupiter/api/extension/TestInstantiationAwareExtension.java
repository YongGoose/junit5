...
public interface TestInstantiationAwareExtension extends Extension {
	 ...
	 * <li>If the callback adds a new {@link org.junit.jupiter.api.extension.ExtensionContext.Store.CloseableResource}
	 * to the {@link Store Store}, the resource is closed just after the instance is
	 * destroyed.</li>
